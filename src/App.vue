...
components: { Navbar, SectionRight, SectionLeft, Footer }
...
<template>
    ...
    <div class="lg:h-full lg:w-full bg-no-repeat bg-cover bg-center bg-cafe">
      <h1 class="font-extrabold lg:text-5xl lg:p-100 align-middle text-center text-white"> Twoway Cafe </h1>
    </div>
